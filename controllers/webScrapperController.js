...
mongoose.connect(
  "mongodb://heroku_1113qw1w:1pede49em3dhg8t36q74rocftc@ds121189.mlab.com:21189/heroku_1113qw1w",
  {
...
module.exports = app => {
    ...
    axios.get("https://www.npr.org/sections/news/").then(response => {
      ...
      $("article").each((i, element) => {
        ...
        if (lowResImageLink) {
          ...
          let highResImage =
            lowResImageLink.substr(0, imageLength - 11) + "800-c100.jpg";
  ...
  app.post("/api/add", (req, res) => {
    ...
    db.Articles.findOne({ url: articleObject.url }) // Save the Article to the Database // Look for an Existing Article with the Same URL
